...
<p><strong>Will be available soon.</strong> The tool page is under preparation; the description above and the supporting scripts are retained and will be enabled when the online tool is ready. In the meantime you can run the local tool at <code>tools/pattern_identifier.py</code>.</p>
