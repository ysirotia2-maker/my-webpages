#!/usr/bin/env python3
"""
Day Candle Identifier

Convert of 'candle for stock name.ipynb' into a small CLI module.
Reads a CSV where each row contains: name,open,high,low,close,volume,turnover
and returns, per candle type, the stock names/dates.
"""
import csv
import sys
import io
